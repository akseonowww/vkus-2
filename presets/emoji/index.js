setTimeout(() => {
   ...
   // Меняем иконку раздела музыки
			...
			.addEventListener(
				...
				() => {
					...
					setTimeout(() => {
						document
							.querySelector(
								"[class*='ModalFooter-module__actionButtons']"
							)
							.insertAdjacentHTML(
								'beforebegin',
								`<label id="VKPlayerAbsolute">
				                    Размер: <input type="text" placeholder="20"/>
				             </label>
	...
	console.log('[VK Player Absolute] end');
}, 3000);
